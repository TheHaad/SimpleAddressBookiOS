...
@property (nonatomic, strong) FetchPersonService *service;
@end
...
- (id<BSModule>)module {
    if (!_module) {
        _module = [[AddressBookModule alloc] init];
    }
    return _module;
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.muntaz.AddressBookSample" in the application's documents directory.
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"AddressBookSample.sqlite"];
    NSError *error = nil;
